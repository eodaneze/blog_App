                ...
                <div class="row gx-55 gx-5">
                    <div class="col-lg-8">
                                    ...
                                    <div class="comment-author-info">
                                        <div class="row align-items-start">
                                            ...
                                            <div class="col-md-3 col-sm-12 col-12 text-md-end order-md-2 order-sm-3 order-3">
                                                <a href="business-details.html#cmt-form" class="reply-btn">Reply</a>
                                            </div>
                        ...
                        <div id="cmt-form">
                            ...
                            <form action="business-details.html#" class="comment-form">
                                <div class="row">
                                    <div class="col-md-6">
                    ...
                    <div class="col-lg-4">
                        <div class="sidebar">
                            <div class="sidebar-widget-two">
                                <form action="business-details.html#" class="search-box-widget">
